    ...
    if(result != null) {
      ...
      setState(() {
        for(int i = 0 ; i < files.length ; i++) {
          String str = String.fromCharCodes(files[i].bytes);
          //File('./my_file.txt').writeAsString(str);
          _firestore.collection('images').add({'name':'67886'});
          var imageIndex = images.length;
          ImageFiles.add(files[i].bytes);
          images.add(
            Stack(
              children: <Widget>[
                GestureDetector(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    ...
                    print(subcategory_default);
                    print(productName);
                    print(price);
                    print(description);
                    print(finalProperties);
                    print(sizeCountValues);
                  },
                  child: Container(
                    height: 50,
                    width: 120,
